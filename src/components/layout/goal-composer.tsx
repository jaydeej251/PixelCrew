...
export function GoalComposer({
  ...
  return (
    <div className={compact ? "w-full" : "mx-auto w-full max-w-2xl"}>
      <div className="rounded-2xl border border-zinc-800 bg-zinc-950/85 p-2 shadow-lg ring-1 ring-white/5 backdrop-blur-md focus-within:border-indigo-500/40">
        <textarea
          className={
            compact
              ? "max-h-28 min-h-[56px] w-full resize-none bg-transparent px-3 py-2 text-sm leading-relaxed text-zinc-100 placeholder:text-zinc-500 focus:outline-none"
              : "max-h-48 min-h-[88px] w-full resize-none bg-transparent px-3 py-2.5 text-[15px] leading-relaxed text-zinc-100 placeholder:text-zinc-500 focus:outline-none"
          }
          rows={compact ? 2 : 3}
          value={value}
